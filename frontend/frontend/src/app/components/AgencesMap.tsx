  ...
  useEffect(() => {
    ...
    const initMap = async () => {
      ...
      agences.forEach((agence) => {
        const marker = L.marker([agence.latitude, agence.longitude], { icon: markerIcon })
          .addTo(map);

        marker.on('click', () => setSelectedAgence(agence));
      });
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-xl shadow-md border border-gray-200 text-center">
            ...
            <p className="text-sm text-gray-600">+229 21 31 30 09</p>
          </div>
        </div>
      </div>
    </section>
