...
const actualites = ACTUALITES.slice(0, 3);
    ...
    <section className="py-16 bg-gray-50" id="actualites">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="md:hidden mt-6 text-center">
          <Link to="/actualites" className="text-blue-500 hover:text-blue-600 hover:gap-3 font-medium flex items-center gap-2 mx-auto transition-all">
            Voir toutes les actualités
            <ArrowRight className="w-5 h-5" />
          </Link>
        </div>
