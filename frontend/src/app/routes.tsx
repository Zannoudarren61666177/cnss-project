...
export const router = createBrowserRouter([
  ...
  {
    path: "/employeur/tableau-de-bord",
    Component: EmployeurDashboard,
  },
  {
    path: "/employeur/declarer-travailleur",
    Component: DeclarerTravailleurPage,
  },
  {
  ...
  },
  {
    ...
    Component: AgentEmployeurDashboard,
  },
  {
    path: "/agent/cotisation",
    Component: AgentCotisationDashboard,
  },
  {
    path: "/agent/prestations",
    Component: AgentPrestationsDashboard,
  },
  {
    path: "/agent/support",
    Component: AgentSupportDashboard,
  },
  {
    path: "/admin",
